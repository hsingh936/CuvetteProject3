const foodOriginalData = [
  ...
  function getAllFoodData(){
    ...
    function getAllProtienAbove100(){
    ...
    function getAllProtienBelow100(){
        const newArr = foodOriginalData.filter(item => item.calorie < 100);
        console.log(newArr);
    }
    ...
    function getProteinContentHighestToLowest(){
        const newArr = foodOriginalData.sort((a,b)=> b.protiens - a.proteins);
        console.log(newArr);
    }

    //list all the food items with lowest cab content to highest//

    function getCabContentLowestToHighest(){
        const newArr = foodOriginalData.sort((a,b)=> a.cab - b.cab);
        console.log(newArr);
    }
